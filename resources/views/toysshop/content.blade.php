         ...
         <div class="container py-lg-5 py-md-5 py-sm-4 py-4">
            ...
            <div class="row banner-below-w3l">
               <div class="col-lg-4 col-md-6 col-sm-6 text-center banner-agile-flowers">
                  <img src="{{ asset('toys/user/images/a1.jpg') }}" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Baby Toys</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 text-center banner-agile-flowers">
                  <img src="{{ asset('toys/user/images/a2.jpg')}}" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Lite-Brite</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 text-center banner-agile-flowers">
                  <img src="{{ asset('toys/user/images/a3.jpg') }}" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Key Toys</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
                  <img src="{{ asset('toys/user/images/a4.jpg')}}" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Play Toys</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
                  <img src="{{ asset('toys/user/images/a5.jpg')}}" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Gift Toys</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
                  <img src="{{ asset('toys/user/images/a6.jpg')}}" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
               ...
               <ul id="flexiselDemo1">
                  <li>
                     <div class="agileinfo_port_grid">
                        <img src="{{ asset('toys/user/images/a1.jpg')}}" alt=" " class="img-fluid" />
                        <div class="banner-right-icon">
                           <h4 class="pt-3">Soft Toys</h4>
                        </div>
                        <div class="outs_more-buttn">
                  ...
                  <li>
                     <div class="agileinfo_port_grid">
                        <img src="{{ asset('toys/user/images/a2.jpg')}}" alt=" " class="img-fluid" />
                        <div class="banner-right-icon">
                           <h4 class="pt-3">Soft Toys</h4>
                        </div>
                        <div class="outs_more-buttn">
                  ...
                  <li>
                     <div class="agileinfo_port_grid">
                        <img src="{{ asset('toys/user/images/a3.jpg')}}" alt=" " class="img-fluid" />
                        <div class="banner-right-icon">
                           <h4 class="pt-3">Soft Toys</h4>
                        </div>
                        <div class="outs_more-buttn">
                  ...
                  <li>
                     <div class="agileinfo_port_grid ">
                        <img src="{{ asset('toys/user/images/a4.jpg')}}" alt=" " class="img-fluid" />
                        <div class="banner-right-icon">
                           <h4 class="pt-3">Soft Toys</h4>
                        </div>
                        <div class="outs_more-buttn">
                  ...
                  <li>
                     <div class="agileinfo_port_grid">
                        <img src="{{ asset('toys/user/images/a5.jpg')}}" alt=" " class="img-fluid" />
                        <div class="banner-right-icon">
                           <h4 class="pt-3">Soft Toys</h4>
                        </div>
                        <div class="outs_more-buttn">
                  ...
                  <li>
                     <div class="agileinfo_port_grid ">
                        <img src="{{ asset('toys/user/images/a6.jpg')}}" alt=" " class="img-fluid" />
                        <div class="banner-right-icon">
                           <h4 class="pt-3">Soft Toys</h4>
                        </div>
                        <div class="outs_more-buttn">
                     ...
                     <div class="row">
                           ...
                           <div class="least-w3layouts-text-gap">
                              <div class="row">
                                 <div class="col-md-4 col-sm-4 news-img">
                                    <img src="{{ asset('toys/user/images/t1.jpg')}}" alt="" class="image-fluid">
                                 </div>
                                 ...
                                 <div class="mt-3 news-agile-text">
                                    <img src="{{ asset('toys/user/images/tt1.jpg')}}" alt="" class="image-fluid">
                        ...
                        <div class="col-lg-6 clients-w3layouts-row">
                           <div class="least-w3layouts-text-gap">
                              <div class="row">
                                 <div class="col-md-4 col-sm-4 news-img">
                                    <img src="{{ asset('toys/user/images/t2.jpg')}}" alt="" class="image-fluid">
                                 </div>
                                 <div class="col-md-8 col-sm-8 clients-says-w3layouts">
                                    <h4>Sam Deo 
                                    </h4>
                                 ...
                                 <div class="mt-3 news-agile-text">
                                    <img src="{{ asset('toys/user/images/tt2.jpg')}}" alt="" class="image-fluid">
                                    <p class="mt-3"><span class="fas fa-quote-left"></span>  velit sagittis vehicula. Duis posuere 
                                       ex in mollis iaculis. Suspendisse tincidunt
                                       velit sagittis vehicula. Duis posuere 
                                       velit sagittis vehicula. Duis posuere <span class="fas fa-quote-right"></span>
                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-6 clients-w3layouts-row">
                           <div class="least-w3layouts-text-gap">
                              <div class="row">
                                 <div class="col-md-4 col-sm-4 news-img">
                                    <img src="{{ asset('toys/user/images/t3.jpg')}}" alt="" class="image-fluid">
                                 </div>
                                 <div class="col-md-8 col-sm-8 clients-says-w3layouts">
                                    <h4>Sam Deo 
                                    </h4>
